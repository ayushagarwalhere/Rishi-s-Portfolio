...
export default function Wind() {
  ...
  return (
    <div className="w-full h-screen fixed z-0 bg-[#0e100f] flex items-center justify-center overflow-hidden">
      <div className="relative w-[90vw] h-[90vh] flex flex-col items-center justify-evenly rounded-lg">
        <svg
          id="svg-stage"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="-40 -180 1250 1100"
          opacity="0"
          className="w-[80%] max-w-187.5 overflow-visible"
        >
          <path
            className="mp"
            fill="none"
